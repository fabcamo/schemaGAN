...
from schemaGAN.interpolation.interpolation_utils import generate_krig_images, get_cptlike_data
...
krig_images = generate_krig_images(no_rows, no_cols, src_images)


########################################################################################################################
coords = coords_all[0]
pixel_values = pixel_values_all[0]
krig_img = krig_images[0]
########################################################################################################################
