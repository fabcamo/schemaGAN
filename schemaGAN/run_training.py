...
if __name__ == "__main__":
    ...
    # Define the log directory and if it does not exist, create it
    ...
    generator = Generator_modular(input_size=(32, 512),
                                  no_inputs=2,
                                  OUTPUT_CHANNELS=1,
                                  base_filters=64,
                                  dropout_layers=3)
    ...
    discriminator = Discriminator_modular(input_size=(32, 512),
                                          no_inputs=4,
                                          base_filters=64)

    # Define the checkpoint directory and if it does not exist, create it
    checkpoint_dir = "checkpoints_geometry_re/"
