...
def plot_histograms_mae(gan, NeNI, idw, krig, NatNI, inpt):
    ...
    axs[0].set_title('MAE in SchemaGAN vs Nearest Nei', fontsize=10)
    ...
    axs[1].set_title('MAE in SchemaGAN vs IDW', fontsize=10)
    ...
    axs[2].set_title('MAE in SchemaGAN vs Kriging', fontsize=10)
    ...
    axs[3].set_title('MAE in SchemaGAN vs Natural Nei', fontsize=10)
    ...
    axs[4].set_title('MAE in SchemaGAN vs Inpainting', fontsize=10)
...
def plot_histograms_mse(gan, NeNI, idw, krig, NatNI, inpt):
    ...
    # Plot histogram for GAN vs Nearest Neighbor in first subplot
    axs[0].hist(gan, bins=10, alpha=0.5, label='GAN', color='gray', edgecolor='dimgray')
    axs[0].hist(NeNI, bins=30, alpha=0.5, label='NeNI', color='goldenrod', edgecolor='dimgray')
    axs[0].axvline(np.mean(gan), color='dimgrey', linestyle='dashed', linewidth=1)
    axs[0].axvline(np.mean(NeNI), color='darkgoldenrod', linestyle='dashed', linewidth=1)
    axs[0].set_xlabel('Mean squared error', fontsize=10)
    axs[0].set_ylabel('Frequency', fontsize=10)
    axs[0].set_title('MSE in SchemaGAN vs Nearest Nei', fontsize=10)
    axs[0].legend(loc='upper right', fontsize=7)
    axs[0].set_xlim(0.0, 0.5)
    axs[0].tick_params(axis='both', labelsize=8)
    ...
    # Plot histogram for GAN vs IDW in second subplot
    axs[1].hist(gan, bins=10, alpha=0.5, label='GAN', color='gray', edgecolor='dimgray')
    axs[1].hist(idw, bins=55, alpha=0.5, label='IDW', color='teal', edgecolor='dimgray')
    axs[1].axvline(np.mean(gan), color='dimgrey', linestyle='dashed', linewidth=1)
    axs[1].axvline(np.mean(idw), color='teal', linestyle='dashed', linewidth=1)
    axs[1].set_xlabel('Mean squared error', fontsize=10)
    axs[1].set_ylabel('Frequency', fontsize=10)
    axs[1].set_title('MSE in SchemaGAN vs IDW', fontsize=10)
    axs[1].legend(loc='upper right', fontsize=7)
    axs[1].set_xlim(0.0, 0.5)
    axs[1].tick_params(axis='both', labelsize=8)
    ...
    # Plot histogram for GAN vs Kriging in third subplot
    axs[2].hist(gan, bins=10, alpha=0.5, label='GAN', color='gray', edgecolor='dimgray')
    axs[2].hist(krig, bins=15, alpha=0.5, label='Krig', color='indigo', edgecolor='dimgray')
    axs[2].axvline(np.mean(gan), color='dimgrey', linestyle='dashed', linewidth=1)
    axs[2].axvline(np.mean(krig), color='indigo', linestyle='dashed', linewidth=1)
    axs[2].set_xlabel('Mean squared error', fontsize=10)
    axs[2].set_ylabel('Frequency', fontsize=10)
    axs[2].set_title('MSE in SchemaGAN vs Kriging', fontsize=10)
    axs[2].legend(loc='upper right', fontsize=7)
    axs[2].set_xlim(0.0, 0.5)
    axs[2].tick_params(axis='both', labelsize=8)
    ...
    axs[3].axvline(np.mean(gan), color='dimgrey', linestyle='dashed', linewidth=1)
    axs[3].axvline(np.mean(NatNI), color='darkgreen', linestyle='dashed', linewidth=1)
    axs[3].set_xlabel('Mean squared error', fontsize=10)
    axs[3].set_ylabel('Frequency', fontsize=10)
    axs[3].set_title('MSE in SchemaGAN vs Natural Nei', fontsize=10)
    axs[3].legend(loc='upper right', fontsize=7)
    axs[3].set_xlim(0.0, 0.5)
    axs[3].tick_params(axis='both', labelsize=8)
    ...
    # Plot histogram for GAN vs Inpt in fifth subplot
    axs[4].hist(gan, bins=10, alpha=0.5, label='GAN', color='gray', edgecolor='dimgray')
    axs[4].hist(inpt, bins=30, alpha=0.5, label='Inpt', color='maroon', edgecolor='dimgray')
    axs[4].axvline(np.mean(gan), color='dimgrey', linestyle='dashed', linewidth=1)
    axs[4].axvline(np.mean(inpt), color='maroon', linestyle='dashed', linewidth=1)
    axs[4].set_xlabel('Mean squared error', fontsize=10)
    axs[4].set_ylabel('Frequency', fontsize=10)
    axs[4].set_title('MSE in SchemaGAN vs Inpainting', fontsize=10)
    axs[4].legend(loc='upper right', fontsize=7)
    axs[4].set_xlim(0.0, 0.5)
    axs[4].tick_params(axis='both', labelsize=8)
...
def plot_histograms_ssim(gan, NeNI, idw, krig, NatNI, inpt):
    """
    Plots three histograms in a row for GAN, Nearest Neighbor, IDW and Kriging.
    ...
    axs[0].axvline(np.mean(gan), color='dimgrey', linestyle='dashed', linewidth=1)
    axs[0].axvline(np.mean(NeNI), color='darkgoldenrod', linestyle='dashed', linewidth=1)
    axs[0].set_xlabel('Structural similarity index', fontsize=10)
    axs[0].set_ylabel('Frequency', fontsize=10)
    axs[0].set_title('SSIM in SchemaGAN vs Nearest Nei', fontsize=10)
    axs[0].legend(loc='upper right', fontsize=7)
    ...
    # Plot histogram for GAN vs IDW in second subplot
    axs[1].hist(gan, bins=10, alpha=0.5, label='GAN', color='gray', edgecolor='dimgray')
    axs[1].hist(idw, bins=80, alpha=0.5, label='IDW', color='teal', edgecolor='dimgray')
    axs[1].axvline(np.mean(gan), color='dimgrey', linestyle='dashed', linewidth=1)
    axs[1].axvline(np.mean(idw), color='teal', linestyle='dashed', linewidth=1)
    axs[1].set_xlabel('Structural similarity index', fontsize=10)
    axs[1].set_ylabel('Frequency', fontsize=10)
    axs[1].set_title('SSIM in SchemaGAN vs IDW', fontsize=10)
    axs[1].legend(loc='upper right', fontsize=7)
    ...
    axs[2].axvline(np.mean(gan), color='dimgrey', linestyle='dashed', linewidth=1)
    axs[2].axvline(np.mean(krig), color='indigo', linestyle='dashed', linewidth=1)
    axs[2].set_xlabel('Structural similarity index', fontsize=10)
    axs[2].set_ylabel('Frequency', fontsize=10)
    axs[2].set_title('SSIM in SchemaGAN vs Kriging', fontsize=10)
    axs[2].legend(loc='upper right', fontsize=7)
    ...
    axs[3].axvline(np.mean(gan), color='dimgrey', linestyle='dashed', linewidth=1)
    axs[3].axvline(np.mean(NatNI), color='darkgreen', linestyle='dashed', linewidth=1)
    axs[3].set_xlabel('Structural similarity index', fontsize=10)
    axs[3].set_ylabel('Frequency', fontsize=10)
    axs[3].set_title('SSIM in SchemaGAN vs Natural Nei', fontsize=10)
    axs[3].legend(loc='upper right', fontsize=7)
    ...
    axs[4].axvline(np.mean(gan), color='dimgrey', linestyle='dashed', linewidth=1)
    axs[4].axvline(np.mean(inpt), color='maroon', linestyle='dashed', linewidth=1)
    axs[4].set_xlabel('Structural similarity index', fontsize=10)
    axs[4].set_ylabel('Frequency', fontsize=10)
    axs[4].set_title('SSIM in SchemaGAN vs Inpainting', fontsize=10)
    axs[4].legend(loc='upper right', fontsize=7)
    axs[4].set_xlim(0.0, 1)
    axs[4].tick_params(axis='both', labelsize=8)
...
def plot_comparison_of_methods_mae(src_img, gen_img, tar_img, nn, idw, kriging, natni, inp, mae_per_img):
    ...
    titles = ['Original cross-section', 'Input CPT data',
              'SchemaGAN prediction', f'SchemaGAN MAE: {mae_per_img[0]:.2f}',
              'Nearest Neighbor', f'Nearest Neighbor MAE: {mae_per_img[1]:.2f}',
              'Inverse Distance Weight', f'Inverse Distance MAE: {mae_per_img[2]:.2f}',
              'Ordinary Kriging', f'Ordinary Kriging MAE: {mae_per_img[3]:.2f}',
              'Natural Neighbor', f'Natural Neighbor MAE: {mae_per_img[4]:.2f}',
...
def plot_comparison_of_methods_mse(src_img, gen_img, tar_img, nn, idw, kriging, natni, inp, mse_per_img):
    ...
    inverse distance interpolated image, kriging interpolated image,
    Natural Neighbor interpolated image, and Inpainting image.
    mse_per_img (np.array): Mean Squared Error of the methods
    """

    # Stack all the images
    images = np.vstack((tar_img, src_img,
                        gen_img, np.square(gen_img - tar_img),
                        nn, np.square(nn - tar_img),
                        idw, np.square(idw - tar_img),
                        kriging, np.square(kriging - tar_img),
                        natni, np.square(natni - tar_img),
                        inp, np.square(inp - tar_img)))

    # Set plot titles for each subplot
    titles = ['Original cross-section', 'Input CPT data',
              'SchemaGAN prediction', f'SchemaGAN MSE: {mse_per_img[0]:.2f}',
              'Nearest Neighbor', f'Nearest Neighbor MSE: {mse_per_img[1]:.2f}',
              'Inverse Distance Weight', f'Inverse Distance MSE: {mse_per_img[2]:.2f}',
              'Ordinary Kriging', f'Ordinary Kriging MSE: {mse_per_img[3]:.2f}',
              'Natural Neighbor', f'Natural Neighbor MSE: {mse_per_img[4]:.2f}',
...
def plot_comparison_of_methods_ssim(src_img, gen_img, tar_img, nn, idw, kriging, natni, inp, ssim_gan_map,
                                    ssim_nn_map, ssim_idw_map, ssim_krig_map, ssim_natnei_map, ssim_inpt_map,
                                    ssim_per_img):
    """
    This function plots the comparison of different methods' results including GAN,
    nearest neighbor interpolation, inverse distance interpolation, kriging interpolation,
    ...
    inverse distance interpolated image, kriging interpolated image,
    Natural Neighbor interpolated image, and Inpainting image.
    ssim_means (np.array): SSIM error of the methods
    all_ssim_maps: tuple containing the SSIM maps for the i-th image for all the methods.
    For example: all_ssim_maps[i][0] will give you the SSIM map for the i-th image using the GAN method
    """

    # Stack all the images
    images = np.vstack((tar_img, src_img,
                        gen_img, ssim_gan_map.reshape(1, 32, 512, 1),
                        nn, ssim_nn_map.reshape(1, 32, 512, 1),
                        idw, ssim_idw_map.reshape(1, 32, 512, 1),
                        kriging, ssim_krig_map.reshape(1, 32, 512, 1),
                        natni, ssim_natnei_map.reshape(1, 32, 512, 1),
                        inp, ssim_inpt_map.reshape(1, 32, 512, 1)))

    # Set plot titles for each subplot
    titles = ['Original cross-section', 'Input CPT data',
              'SchemaGAN prediction', f'SchemaGAN SSIM: {ssim_per_img[0]:.2f}',
              'Nearest Neighbor', f'Nearest Neighbor SSIM: {ssim_per_img[1]:.2f}',
              'Inverse Distance Weight', f'Inverse Distance SSIM: {ssim_per_img[2]:.2f}',
              'Ordinary Kriging', f'Ordinary Kriging SSIM: {ssim_per_img[3]:.2f}',
              'Natural Neighbor', f'Natural Neighbor SSIM: {ssim_per_img[4]:.2f}',
              'Inpainting', f'Inpainting MAE: {ssim_per_img[5]:.2f}']
...
def generate_boxplot(gan, nearnei, idw, krig, natnei, inpt, method):
    ...
    ax.set_xticklabels(['SchemaGAN', 'Nearest Neighbour', 'IDW', 'Kriging', 'Natural Neighbour', 'Inpainting'])
