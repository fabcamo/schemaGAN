...
from schemaGAN.interpolation.interpolation_utils import get_cptlike_data, generate_nearnei_images
...
nearnei_images = generate_nearnei_images(no_rows, no_cols, src_images)


########################################################################################################################
coords = coords_all[0]
pixel_values = pixel_values_all[0]
nearnei_img = nearnei_images[0]
