...
if __name__ == "__main__":
    cpts_A = read_files(r"cptdata/2422-220749_Sonderingen_GEF")
    data_cpts1 = process_cpts(cpts_A, file="A")
    cpts_B = read_files(r"cptdata/cpts_BRO_in_embankment")
    ...
    all_cpts.to_csv(r'cptdata/raw_all_CPT_data.csv', index=False)

    # Restructure the DataFrame
    only_IC = restructure_df(all_cpts)

    # save combined dataframe to csv
    only_IC.to_csv(r"cptdata/raw_IC_and_depth.csv", index=False)
